...
export default function ContactPage() {
  const [state, handleSubmit] = useForm("xyyqzzzz"); // TODO: replace with your actual Formspree form ID

  return (
    <>
      <motion.div className="h-screen flex items-center overflow-clip">
        {/* Background image with zoom-in animation */}
        <motion.div className="absolute inset-0 bg-[url('/assets/nhc-1.png')] bg-fixed bg-cover bg-center opacity-80" />
        ...
        <div className="container relative z-20 ">
          ...
          >
            <h1 className="text-3xl lg:text-7xl font-bold text-primary mb-2 ">
              Contact Nakowa Health Care
            </h1>
            <p className="text-lg text-onyx/80 ml-1">
              We&#39;d love to hear from you. For appointments, enquiries or feedback, reach out by phone, email or the form below.
            </p>
            {/* CTA Buttons */}
            <motion.div
            ...
            >
              ...
              >
                <Link
                  href="mailto:info@nakowahealthcentre.org"
      ...
      <section className="py-20 container mx-auto px-4 md:px-8 lg:px-16">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h2 className="text-xl font-bold text-center text-sacramento mb-4">
              Our Location
            </h2>
            <address className="text-center not-italic text-onyx/80">
              No 12, Kafancha road, off Kulende Estate Phase II, Kulende, Sango,
              Ilorin, Kwara state <br />
              <a
                href="https://maps.app.goo.gl/T7QN7nDGfdVzTEuu9"
                target="_blank"
          ...
          >
            ...
            <div className="text-center text-onyx/80 space-y-2">
              <p>
                General Enquiries:{" "}
                <a href="tel:+2347030189611" className="text-primary-600">
                  0703 018 9611
                </a>
              </p>
              <p>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.7286739730403!2d4.5948774746646235!3d8.525701496664887!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x10364d221a01cf01%3A0xe8792d6d5c3101c4!2sSango%2C%20Ilorin%20Kwara%20state%20Nigeria!5e0!3m2!1sen!2sng!4v1771228167964!5m2!1sen!2sng"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16 text-center">
          ...
          >
            ...
            <p className="text-lg text-onyx/80 mb-6 max-w-2xl mx-auto">
              For immediate medical attention, please call our emergency line or
      ...
      >
        <a
          ...
          aria-label="Chat with Nakowa Health Care on WhatsApp"
        >
          <svg
